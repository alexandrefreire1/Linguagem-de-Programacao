# Implemente uma aplicação que recebe, através do teclado, um texto em português
# e o traduza para o inglês ou espanhol com a API JSON do Google Tradutor, conforme escolha do usuário.
# Por fim, apresente o texto traduzido na tela.
